...
if user_choice == "bond":
    ...
    while True: 
        try:
            ...
            i_rate = float(input("Please enter the interest rate as a percentage (e.g if the interest rate is 4%, please enter '4' without the sign'%'): "))  # input 7
            ...
            n_months = int(input("Please enter the number of months you plan to take to repay the loan (e.g. 20 years equals to 240 months): "))   # input 8
